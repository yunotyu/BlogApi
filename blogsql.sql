...
-- Records of article
-- ----------------------------
INSERT INTO `article` VALUES (1, '但是福建省', '发奖金阿迪斯', '怪卡的', '加速度', '2023-04-04 16:34:36', NULL, NULL, NULL, b'0');
...
-- Records of comments
-- ----------------------------
INSERT INTO `comments` VALUES (1, 2, '十点多撒', '2023-04-04 16:34:55', '阿萨德', b'0');
...
CREATE TABLE `operatelog`  (
  ...
  `isDel` bit(1) NULL DEFAULT b'0' COMMENT '0:未删除，1:已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `permission`  (
  ...
  `isBtn` bit(1) NULL DEFAULT b'0' COMMENT '是否显示菜单为按钮，0代表不显示，1显示',
  `isShow` bit(1) NULL DEFAULT b'0' COMMENT '是否显示该菜单项，0代表不显示，1代表显示',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `enable` bit(1) NULL DEFAULT b'1' COMMENT '是否启用，1代表启用，0代表不启用',
  `isDel` bit(1) NULL DEFAULT b'0' COMMENT '是否逻辑删除，0代表未删除，1代表删除\r\n是否逻辑删除，0代表未删除，1代表删除',
  ...
  CONSTRAINT `menuIdForKey` FOREIGN KEY (`menuId`) REFERENCES `menus` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of permission
-- ----------------------------
INSERT INTO `permission` VALUES (2, NULL, b'0', b'1', NULL, b'1', b'0', 'admin', '2023-04-04 17:29:51', NULL, NULL, 1);
INSERT INTO `permission` VALUES (3, NULL, b'0', b'0', NULL, b'1', b'0', 'admin', '2023-04-04 17:32:00', NULL, NULL, 2);
INSERT INTO `permission` VALUES (4, NULL, b'0', b'0', NULL, b'1', b'0', 'admin', '2023-04-04 17:32:16', NULL, NULL, 3);
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, '管理员', NULL, NULL, b'1', b'0', '管理员', '2023-04-04 17:05:16', NULL);
...
CREATE TABLE `rolepermission`  (
  ...
  `isDel` bit(1) NULL DEFAULT b'0' COMMENT '是否逻辑删除，0代表未删除，1代表删除',
  `enabel` bit(1) NULL DEFAULT b'1' COMMENT '是否启用，1代表启用，0代表不启用',
  `createUsername` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
  `createTime` datetime(0) NULL DEFAULT NULL,
  ...
  CONSTRAINT `perForKey` FOREIGN KEY (`permissionId`) REFERENCES `permission` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `roleForKey` FOREIGN KEY (`roleId`) REFERENCES `role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of rolepermission
-- ----------------------------
INSERT INTO `rolepermission` VALUES (1, 1, 2, b'0', b'1', 'admin', '2023-04-04 17:34:01', NULL, NULL);
INSERT INTO `rolepermission` VALUES (2, 1, 3, b'0', b'1', 'admin', '2023-04-04 17:34:19', NULL, NULL);
INSERT INTO `rolepermission` VALUES (3, 1, 4, b'0', b'1', 'admin', '2023-04-04 17:34:39', NULL, NULL);
...
CREATE TABLE `user`  (
  ...
  `isDel` bit(1) NULL DEFAULT b'0' COMMENT '是否逻辑删除，0代表未删除，1代表删除',
  `isEnable` bit(1) NULL DEFAULT b'1' COMMENT '是否启用，1代表启用，0代表不启用',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin', '2023-04-03 17:25:44', NULL, NULL, NULL, NULL, NULL, NULL, NULL, b'0', b'1', NULL);
...
CREATE TABLE `userrole`  (
  ...
  CONSTRAINT `roleidForKey` FOREIGN KEY (`roleId`) REFERENCES `role` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `useridForKey` FOREIGN KEY (`userId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of userrole
-- ----------------------------
INSERT INTO `userrole` VALUES (1, 1, 1, b'0', b'1', 'admin', '2023-04-04 17:32:52', NULL, NULL);
